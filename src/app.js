...
function renderSeasonTeam(report) {
  ...
  return `<section class="card season-team-card"><div class="card-header"><h3>Time do campeonato</h3><span>Formação 4-3-3 · mínimo de ${report.teamOfSeasonMinimumAppearances ?? 3} jogos</span></div><div class="season-team-pitch"><div class="field-markings" aria-hidden="true"><span class="field-center-circle"></span><span class="field-center-spot"></span><span class="field-box field-box-top"><i></i><b></b></span><span class="field-box field-box-bottom"><i></i><b></b></span></div>${positions.map(row => `<div class="season-team-row" style="--players:${row.length}">${row.map(playerCard).join("")}</div>`).join("")}</div></section>`;
}
